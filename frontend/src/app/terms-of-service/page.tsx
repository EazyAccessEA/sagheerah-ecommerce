      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Agreement to Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Description of Service</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">User Accounts</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Acceptable Use</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Intellectual Property</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Privacy Policy</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Newsletter Subscription</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Disclaimers</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Limitation of Liability</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Indemnification</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Governing Law</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Changes to Terms</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[#0F2F2E] mb-4">Contact Information</h2>
            <p className="text-gray-700 mb-4">
