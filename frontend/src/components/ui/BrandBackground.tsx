  ...
  return (
    <div className={`relative min-h-screen ${className}`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 opacity-[0.02] transform rotate-12">
          <Image
            src="/brand-motif.png"
            alt=""
            width={384}
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 opacity-[0.015] transform -rotate-6">
          <Image
            src="/brand-motif.png"
            alt=""
            width={256}
        ...
        <div className="absolute top-1/2 left-1/2 w-48 h-48 opacity-[0.01] transform -translate-x-1/2 -translate-y-1/2">
          <Image
            src="/brand-motif.png"
            alt=""
            width={192}
